...
CURATED: list[Firm] = [
    ...
    Firm("Union Square Ventures", "usv.com", ["generalist", "consumer", "crypto", "climate"], "early", "US"),
    Firm("Lux Capital", "luxcapital.com", ["deeptech", "biotech", "ai", "defense"], "multi", "US"),
    Firm("DCVC", "dcvc.com", ["deeptech", "climate", "ai", "biotech"], "multi", "US"),
    Firm("Felicis", "felicis.com", ["generalist", "ai", "saas", "healthcare"], "early", "US"),
    Firm("Ribbit Capital", "ribbitcap.com", ["fintech", "crypto"], "multi", "US"),
    Firm("a16z Bio + Health", "a16z.com", ["biotech", "healthcare"], "multi", "US"),
    Firm("Emergence Capital", "emcap.com", ["saas", "enterprise", "ai"], "early", "US"),
    Firm("Boldstart Ventures", "boldstart.vc", ["enterprise", "saas", "ai", "devtools"], "seed", "US"),
    Firm("Amplify Partners", "amplifypartners.com", ["devtools", "ai", "infrastructure", "enterprise"], "seed", "US"),
    Firm("Homebrew", "homebrew.co", ["generalist", "fintech", "consumer"], "seed", "US"),
    Firm("Precursor Ventures", "precursorvc.com", ["generalist", "consumer", "saas"], "seed", "US"),
    Firm("Breakthrough Energy Ventures", "breakthroughenergy.org", ["climate", "deeptech"], "multi", "US"),
    Firm("Energy Impact Partners", "energyimpactpartners.com", ["climate", "energy"], "multi", "US"),
    Firm("Congruent Ventures", "congruentvc.com", ["climate", "deeptech"], "seed", "US"),
    Firm("Andreessen Horowitz Games", "a16zgames.com", ["gaming", "consumer"], "multi", "US"),
    Firm("Costanoa Ventures", "costanoavc.com", ["saas", "enterprise", "fintech"], "seed", "US"),
    Firm("SciFi VC", "scifi.vc", ["fintech", "deeptech"], "early", "US"),
    Firm("Village Global", "villageglobal.vc", ["generalist"], "seed", "US"),
    Firm("Haystack", "haystack.vc", ["generalist", "saas"], "seed", "US"),
    # --- Europe ---
    ...
    Firm("Point Nine", "pointnine.com", ["saas", "b2b", "marketplace"], "seed", "EU"),
    Firm("EQT Ventures", "eqtventures.com", ["generalist", "saas", "deeptech"], "multi", "EU"),
    Firm("Kima Ventures", "kimaventures.com", ["generalist"], "seed", "EU"),
    Firm("Air Street Capital", "airstreet.com", ["ai", "deeptech"], "seed", "EU"),
    Firm("World Fund", "worldfund.vc", ["climate", "deeptech"], "early", "EU"),
    Firm("2150", "2150.vc", ["climate", "urbantech"], "multi", "EU"),
    Firm("Project A", "project-a.com", ["generalist", "saas", "b2b"], "early", "EU"),
    Firm("Antler", "antler.co", ["generalist"], "seed", "EU"),
    Firm("Hoxton Ventures", "hoxtonventures.com", ["generalist", "deeptech", "healthcare"], "seed", "EU"),
    Firm("Blossom Capital", "blossomcap.com", ["generalist", "fintech", "saas"], "early", "EU"),
    Firm("Dawn Capital", "dawncapital.com", ["saas", "fintech", "b2b"], "early", "EU"),
    # --- Asia ---
